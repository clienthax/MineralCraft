package com.owloctogons.mineralcraft.world;
...
public class generatePheonixShardOre implements IWorldGenerator {
	...
	private void GenerateOverworld(Random random, int x, int z, World world) {
		this.addOreSpawn(main.pheonixShardOre, world, random, x, z, 1, 2, 5, 0, 16);
	}
    ...
    {
        WorldGenMinable minable = new WorldGenMinable(block, (minVeinSize + random.nextInt(1)), Blocks.diamond_ore);
